...
export function SiteHeader() {
  ...
  // Handle chat navigation based on auth state
      ...
      {mobileOpen && (
        <div className="md:hidden border-t border-border">
          <nav className="container py-4 flex flex-col gap-3">
            ...
            <a href="#" onClick={handleChatClick} className="text-sm font-medium text-muted-foreground hover:text-foreground cursor-pointer">{t("chat")}</a>
